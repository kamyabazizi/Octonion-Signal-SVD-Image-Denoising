...
I1=imread('feathers_ms_02.png');I2=imread('feathers_ms_05.png');
I3=imread('feathers_ms_07.png');I4=imread('feathers_ms_12.png');
I5=imread('feathers_ms_15.png');I6=imread('feathers_ms_20.png');
I7=imread('feathers_ms_28.png');
Z=zeros(512);
...
delta=(d/3900);
I1=imnoise(I1,'gaussian',0,delta);I2=imnoise(I2,'gaussian',0,delta);I3=imnoise(I3,'gaussian',0,delta);I4=imnoise(I4,'gaussian',0,delta);I5=imnoise(I5,'gaussian',0,delta);I6=imnoise(I6,'gaussian',0,delta);I7=imnoise(I7,'gaussian',0,delta);
